...
| Binutils | X60 Vendor Extension | Under Review | PATCH v6 | Contributed by SpacemiT |
...
| LLVM | A100 Vendor Extension | WIP | TBD | `xsmtvdotii` |
| LLVM | A100 Fusion | N/A | N/A | Same as X60 |
| GCC | X100 Processor Definition & Schedule Model | WIP | TBD |  |
| GCC | A100 Processor Definition & Schedule Model | WIP | TBD |  |
| GCC | A100 Vendor Extension | WIP | TBD |  |
| Binutils | A100 Vendor Extension | Under Review | [PATCH v6](https://sourceware.org/pipermail/binutils/2026-May/149417.html) | Contributed by SpacemiT |
